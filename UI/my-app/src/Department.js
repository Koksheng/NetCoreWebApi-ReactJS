                        ...
                        <tr>
                            <th>
                                <div className="d-flex flex-row">
                                    <input className="form-control m-2" onChange={this.changeDepartmentIdfilter} placeholder="Filter"></input>
                            ...
                            <th>
                                <div className="d-flex flex-row">
                                    <input className="form-control m-2" onChange={this.changeDepartmentNamefilter} placeholder="Filter"></input>
                                    <button type="button" className="btn btn-light"
